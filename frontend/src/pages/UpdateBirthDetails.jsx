...
const UpdateBirthDetails = () => {
    ...
    useEffect(() => {
        const savedDetails = JSON.parse(localStorage.getItem('birthDetails'));
        if (savedDetails) {
            setForm({
                name: savedDetails.name || '',
                dateOfBirth: savedDetails.dateOfBirth || '',
                timeOfBirth: savedDetails.timeOfBirth || '',
                placeOfBirth: savedDetails.placeOfBirth || '',
            });
        }
    }, []);
    ...
    const handleSubmit = async e => {
        ...
        if (!sessionId) {
            setApiError('Session not found. Please register again.');
            return;
        }
    ...
    return (
        <div className="register-container">
            <h2>Update Your Birth Details</h2>
...
export default UpdateBirthDetails;
